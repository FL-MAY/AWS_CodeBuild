...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'scrubber_gazebo' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/yangjian/AWS_CodeBuild/AWS_CodeBuild/Roboscrub_ws/install/${idir}'.  ${_report}")
    endif()
